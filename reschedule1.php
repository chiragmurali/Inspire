...
if($conn==true)
   ...
   if($checkrows>0) {
	   ?><?php
	 $query="DELETE FROM `timetable` WHERE day='$day' and time='$time'";
	 $result = mysqli_query($conn, $query) or die('Error querying database.');?>
	    <center><h3><b><?php echo "Scheduled class deleted successfully!!!";?></b></h3></center>
      
	  <?php
   } else {  ?>
    <b><center><h3> <?php echo "Sorry there is no class scheduled in this time and day"; ?></h3></b></center>
