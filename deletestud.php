...
if($conn==true)
   ...
   if($checkrows>0) {
		$result=mysqli_query($conn,"DELETE FROM `addstu` WHERE name='$name'");
		?> <center><h3><b><?php echo "Student Deleted";?></b></h3></center><?php
	}
   
   else{
	   ?><center><b><h3><?php echo "Student not present";
   }
